...
describe("calculate most forked repos", () => {
  ...
  it("should return top 5 most forked repositories", () => {
  ...
  it("should sort repositories by fork count in descending order", () => {
    const result = calculateMostForkedRepos(mockRepositories);
...
describe("calculate most starred repos", () => {
  ...
  it("should return top 5 most starred repos", () => {
  ...
  it("should sort repositories by star count in descending order", () => {
    const result = calculateMostStarredRepos(mockRepositories);
...
describe("calculates popular languages", () => {
  it("should return empty array for empty input", () => {
    const result = calculatePopularLanguages([]);
    expect(result).toEqual([]);
  });

  it("should return empty array when no languages are present", () => {
    const repoWithNoLanguage: Repository[] = [
      { ...mockRepositories[0], languages: { edges: [] } },
    ];

    const result = calculatePopularLanguages(repoWithNoLanguage);
    expect(result).toEqual([]);
  });

  it("should return top 5 most used languages", () => {
  ...
  it("should count language ocurrences correctly", () => {
    const result = calculatePopularLanguages(mockRepositories);
    const jsCount = result.find((lang) => {
